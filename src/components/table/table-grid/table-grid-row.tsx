...
import { getRowHeightValue } from "@/utils/data-grid-helper";

interface TableGridRowProps<TData> extends ComponentProps<"div"> {
	row: Row<TData>;
...
export const TableGridRow = memo(TableGridRowImpl, (prev, next) => {
	...
	return false;
}) as typeof TableGridRowImpl;

function TableGridRowImpl<TData>({
	row,
	virtualRowIndex,
	rowVirtualizer,
	rowMapRef,
